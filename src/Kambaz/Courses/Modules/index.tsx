    ...
    return (
        <div>
            ...
            <ul id="wd-modules">
                ...
                <ul className="wd-lessons">
                    <li className="wd-lesson">
                        ...
                        <ul className="wd-content">
                            ...
                            <li className="wd-content-item">Creating HTTP Server with Node.js
                            </li>
                ...
                <li className="wd-module">
                    <div className="wd-title">Week 1, Lecture 2 - Formatting User Interfaces With
                        HTML
                    </div>
                    <ul className="wd-lessons">
                        <li className="wd-lesson">
                            <span className="wd-title">LEARNING OBJECTIVES</span>
                            <ul className="wd-content">
                                <li className="wd-content-item">Learn how to create users interfaces with HTML</li>
